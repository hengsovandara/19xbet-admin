...
export const classNameBg = active =>
  fucss({
    'ps:rl dp:flx fd:col ai:c jc:sb flxw:wrap p:15px h:calc(100pc-200px) sm-h:calc(100pc-250px)': true,
    'bg:white': active,
    'bg:6BC4BC': !active
  })
...
export const classNameChangeBtn = () =>
  fucss({
    'b:15px l:50pc trx:50npc ps:ab-! bg:fffa9_c:black_br:5px_fs:80pc_p:10px-15px_m-t:15px_md-m-t:0_w:100pc_mnw:100px_md-w:auto_bd:0_fw:600_label hv-bs:1_label p-b:2px_svg': true
  })
...
export const classNameImage = document =>
  fucss({
    'bg-rp:nrp bg-pos:c bg-sz:cover h:200px flxb:50pc sm-h:250px crs:pnt ps:rl': true,
    'bg-pos:l': document
  })
