...
export default ({ light, single, cameraMode, onClose, onFullscreen, onSwitchCamera, uploadImages, handleCameraModeToggle, dragEnterOver, handleDrop, handleClick, triggerUpload }) => {
  return (
      ...
      {!cameraMode ? (
        <div className="p:20px">
          <div className={classNameInner(light)}>
            ...
            <div className="ps:ab t:10px r:12px lh:1 fs:24px c:white crs:pt" onClick={onClose}>
              <FontAwesomeIcon className="c:white hv-c:prim-! ts:all" icon="times" />
            </div>
          </div>
          <div className="dp:flx fd:col md-fd:row jc:c ai:c ta:c w:100pc c:white p:20px p-b:0">
            <div className="w:100pc mxw:200px p-tb:20px bd-b:1px-sd-whitea2 md-bd-b:0 md-bd-r:1px-sd-whitea2">
              <div className="dp:flx jc:c ai:c crs:pt hv-c:prim ts:all" onClick={handleCameraModeToggle}>
                <div>
                  ...
                  <p className="p:15px mdx-p-b:0 fs:85pc fw:600">Take a photo using your camera</p>
                </div>
              </div>
            </div>
            <div className="w:100pc mxw:200px p-tb:20px">
...
const classNameContainer = light =>
  ...
  fucss({
    'p-b:20px p-t:25px md-p-t:15px bd-b:1px-sd-whitea4': true
  })
